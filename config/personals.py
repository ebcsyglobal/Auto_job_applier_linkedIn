...
# Your legal name
first_name = "Eric"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Shane"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Brister"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "5125637579"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Austin"                  # Los Angeles, San Francisco, etc.
'''
